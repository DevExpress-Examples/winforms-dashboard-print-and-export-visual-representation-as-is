...
Namespace DashboardExport
	Friend Class CustomDashboardExporter
...
#Region "IPrintable"
		...
		Private Function IPrintable_SupportsHelp() As Boolean Implements IPrintable.SupportsHelp
			Return False
		End Function
		Private Sub IBasePrintable_CreateArea(ByVal areaName As String, ByVal graph As BrickGraphics) Implements IBasePrintable.CreateArea
		...
		End Sub
		Private Sub IBasePrintable_Initialize(ByVal ps As PrintingSystemBase, ByVal link As LinkBase) Implements IBasePrintable.Initialize
		End Sub
#End Region
	End Class
End Namespace
